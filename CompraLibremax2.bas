Attribute VB_Name = "CompraLibremax2"
Sub CopiarComprasBD()
...
Set wbDestino = Workbooks.Open(ActiveWorkbook.Path & "\ACUM - MOV COMPRAS V3.0.xlsm")
...
Set wsDestino = wbDestino.Worksheets("Acum-Compra")
